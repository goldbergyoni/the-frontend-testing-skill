...
- I would like to add a new feature to the users page ( @src2/pages/Organization/Organization.tsx )
- The feature is a reset button to reset the teams/all-users filter in the left side of the screen, right next to the "Users" title .
- I do not really care about how it will look exactly. you can decide alone how the button will look like, etc

# Instructions and explanations:

1. Add a small button- "Reset" right next to the teams filter "Select" component.
2. Clicking on it should reset the state of the "Select"- back to "all users"
3. The obvious side-effect from this reset is that the table will display the right state as well (all users- instead of a specific team's users)

Please code in a spec-driven development way. So you should have a context foder e.g. ./claude/tasks where you handle the spec.md, the tasks.md, and other supporting artifacts. When working with agents and skills, please pass the context folder
...
- Onboarding command
- Demo with a page story
- Helpers
- Remove test write agent
- When to implement the tests
- page analysis network activity lacks details
