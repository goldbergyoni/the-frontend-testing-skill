...
- Compare against baseline (if testskill.planner recorded one)
...
Write a markdown report in the test context folder (same folder as test-plan.md), the file name should be taken from config.outputs.test_result_report :
